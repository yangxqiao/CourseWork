 ...
 * Generated at: 2019-11-30 22:02:43 UTC
...
public final class Detail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if(n!=null){ //someone logged in
      ...
      out.write("\t\t\t//var listProfessor = JSON.parse(xhttp.responseText);\n");
      out.write("\t\t\tlistProfessor = profs.split(\",\");\n");
      out.write("\t\t\tlistGPAstring = gpas.split(\",\")\n");
      out.write("\t\t\t/* if(listProfessor.length==listGPAstring.length){\n");
      out.write("\t\t\t\tconsole.log(\"equal length\");//for debug\n");
      out.write("\t\t\t}\n");
      out.write("\t\t\tvar i;\n");
      out.write("\t\t\tfor(i = 0; i < listProfessor.length; i++)\n");
      out.write("\t\t\t{\n");
      out.write("\t\t\t\tconsole.log(\"checking responseText, \"+listProfessor[i]+\" \"+listGPAstring[i]);\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t} */\n");
      out.write("\t\t\t\n");
      out.write("\t\t} \n");
