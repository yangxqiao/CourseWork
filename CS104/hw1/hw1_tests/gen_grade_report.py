...
RUBRIC_STR = os.path.join(source_dir, 'rubric', 'str.config')
RUBRIC_SUM = os.path.join(source_dir, 'rubric', 'sum_pairs.config')
RUBRIC_TWEET = os.path.join(source_dir, 'rubric', 'tweet_parse.config')
...
P3 = cs_grading.Problem(HOMEWORK, 3, 'tweet_parse', 18)
P4 = cs_grading.Problem(HOMEWORK, 4, 'sum_pairs', 16)
P6 = cs_grading.Problem(HOMEWORK, 6, 'str', 27)
for problem, rubric in [(P3, RUBRIC_TWEET), (P4, RUBRIC_SUM), (P6, RUBRIC_STR)]:#[(P1, RUBRIC_LOGIN), (P2, RUBRIC_HEAP), (P3, RUBRIC_RECS)]:
