 ...
 * Generated at: 2019-11-30 03:49:19 UTC
...
public final class Detail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("      \t\t\tconsole.log(\"in getChartInfo()\");\n");
      out.write("      \t\t\tvar xhttp = new XMLHttpRequest();\n");
      out.write("      \t\t\tvar term = document.getElementById('term-dropdown').value;\n");
      out.write("      \t\t\t/* xhttp.open(\"GET\", \"chartServlet?term=\" + term.options[term.selectedIndex].text + \"&course=\" + document.getElementById(\"course\").value, true); */\n");
      out.write("      \t\t \txhttp.open(\"GET\", \"chartServlet?term=20193&course=CSCI104\", true); \n");
      out.write("      \t\t\tvar id = 'columnchart_values';\n");
      out.write("      \t\t\t\n");
      out.write("      \t\t\txhttp.onload = function(){\n");
      out.write("       \t\t\t\tvar listProfessor = (");
      out.print((ArrayList<String>)session.getAttribute("listProfessor") );
      out.write(");\n");
      out.write("      \t\t\t\tvar listGPA = (");
      out.print((ArrayList<Integer>)session.getAttribute("listGPA") );
      out.write("); \n");
      out.write("      \t\t\t\t\n");
      out.write("          \t\t\tvar id = \"columnchart_values\";\n");
      out.write("          \t\t\t\n");
      ...
      out.write("    \t\t        \ttitle: \"GPA of CSCI201 in Fall 2019\",\n");
      out.write("    \t\t        \twidth: 600,\n");
      ...
      out.write("    \t\t        };\n");
      out.write("    \t      \t\tvar chart = new google.visualization.ColumnChart(document.getElementById(id));\n");
	...
	if(n!=null){ //someone logged in
      ...
      out.write("\t\t<tr>\n");
      out.write("\t\t\t<td>\n");
      out.write("\t\t\t\t<h4 style=\"color:grey\">Term</h4>\n");
      ...
      out.write("\t\t  \t\n");
      out.write("\t\t  \t<td>\n");
      out.write("\t\t  \t\t<h4 style=\"color:grey\">Professor</h4>\n");
      ...
      out.write("\t</table>\n");
      out.write("\t\n");
      out.write("\t<h1>The average GPA for <span id=\"term\"></span> by <span id=\"professor\"></span> is</h1>\n");
      out.write("\t<div id=\"specificGPA\" style=\"text-align:center\"></div>\n");
      ...
      out.write("\t\t\t//console.log(\"in select()\");\t\t\t\n");
      out.write("\t\t\tvar term = document.getElementById(\"term-dropdown\").value;\n");
      ...
      out.write(" \t\t\t}\n");
      out.write(" \t\t\telse{\n");
      out.write(" \t\t\t\tdocument.getElementById(\"professor\").innerHTML = professor;\n");
      out.write(" \t\t\t}\n");
      out.write("\t\t\t\n");
      ...
      out.write("\t \t\t}\n");
      out.write("\t \t\tif(arr[1]!=-1){\n");
      out.write("\t\t\t\tdocument.getElementById(\"challenging\").innerHTML=arr[1]+'% of the students think this course is challenging.';\n");
      out.write("\t \t\t}\n");
      out.write("\t\t\tif(arr[2]!=-1){\n");
      out.write("\t\t\t\tdocument.getElementById(\"recommendRate\").innerHTML=arr[2]+'% of the students recommend this course with this professor.';\n");
      out.write("\t\t\t}\n");
      out.write("\t\t \t");
      out.write("\t\t \t\t\t\n");
      out.write("\t\t}\n");
